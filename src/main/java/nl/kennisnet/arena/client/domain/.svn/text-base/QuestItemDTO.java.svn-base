...
public class QuestItemDTO implements Serializable {
   ...
   public String toString() {
      return "QuestItemDTO [alt=" + alt + ", correctOption=" + correctOption + ", description=" + description + ", id=" + id
            + ", name=" + name + ", objectURL=" + objectURL + ", option1=" + option1 + ", option2=" + option2 + ", option3="
            + option3 + ", option4=" + option4 + ", point=" + point + ", radius=" + radius + ", typeName=" + typeName + "]";
   }
   ...
   public int hashCode() {
      ...
      result = prime * result + ((objectURL == null) ? 0 : objectURL.hashCode());
