...
public class QuestService {
    ...
    public long participateInQuest(long participantId, Long questId) {

        Participant participant = participantRepository.get(participantId);
        Quest quest = questRepository.get(questId);

        Participation participation = participationRepository.findParticipation(participant, quest,
                quest.getActiveRound());
